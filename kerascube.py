...
data = tf.keras.utils.image_dataset_from_directory('C:/Users/Andy/Desktop/moca training/cubes/cubes', labels="inferred") # api that loads data into dataset while also applying image filters
...
model.save(os.path.join('models','cubes.h5'))